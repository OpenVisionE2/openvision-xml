...
"""
Lyngsat Grabber, downloads all available satellites and creates satellites-atlantic.xml
"""
import re
import sys
import time
...
class Lyngsat(object):
    ...
    def get_urls(self):
        ...
        for region in self.__satlist:
            ...
            url = 'https://www.lyngsat.com/' + region + '.html'
            res = SESSION.get(url)
...
def cli_args():
    ...
    parser.add_argument('-f', '--filename', default='satellites-atlantic.xml',
